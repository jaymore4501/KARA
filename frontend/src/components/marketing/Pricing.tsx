        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start max-w-6xl mx-auto">
          {PRICING_PLANS.map((plan, idx) => {
            return (
              <div
                key={idx}
                className={`relative overflow-hidden rounded-[24px] p-8 flex flex-col justify-between min-h-[580px] border transition-all duration-500 shadow-2xl hover:translate-y-[-4px] ${
                  plan.isPopular
              ...
              >
                ...
                <div className="mt-8">
                  <button
                    ...
                    className={`w-full py-3.5 rounded-2xl text-xs font-semibold tracking-wide transition-all duration-300 ${
                      plan.isPopular
